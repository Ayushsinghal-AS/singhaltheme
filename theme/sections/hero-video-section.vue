<template>
  <div class="section-wrapper full-width-section" v-if="render" :style="`margin-bottom: ${global_config.props.margin_between}px;${dynamicStyles}`" :class='[global_config.props.anim_name]'>
