    ...
    <fdk-product-card class="product-card-container">
      <template slot-scope="productData">
        ...
        >
            ...
            <template slot-scope="accountsData">
              ...
              >
                <div v-if="product.follow" style="text-align: center">
                  ...
                  <svg v-if="!isWishListPage" width="21" height="19" viewBox="0 0 21 19" fill="none"
                    ...
                    <path
                      ...
                      fill="#26201A" stroke="#26201A" stroke-width="1.5" />
                  </svg>
          ...
          ></fdk-accounts>
          <div class="product-image" :class="{ 'enable-opacity': !product.sellable }" 
            >
              <emerge-image
              :src="imageUrl"
              :alt="imageAlt"
        ...
        <div class="product-desc" :class="{ 'disable-cursor': !product.sellable }">
          ...
          <div class="card-desc">
            ...
            <div
              class="ukt-title regular-xxxs font-body"
              :title="product.name"
            >
              {{ product.name }}
            </div>
