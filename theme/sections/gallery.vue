<template>
  <div class="section-wrapper full-width-section" :style="`margin-bottom: ${global_config.props.margin_between}px;`">
    <div class="gallery-container">
      <div class="card-container">
        <div class="top-items" :class='[global_config.props.anim_name]'>
          <div class="title-block">
            <div class="font_head font-header"
              v-if="
          ...
          <template v-if="settings.blocks.length > 0">
            ...
            <div
              ...
              <div class="glide-cont" :class="'glide' + _uid" ref="glide">
                <div class="div1">
                  <div class="stickyContent font-header">
                    {{ settings.props.title.value }}
                  </div>
...
.gallery-container {
  ...
  @media screen and (max-device-width: @md-min) {
    .grid5_item_1 {
  ...
  @media only screen and (max-width: @md-min) and (min-width: @sm-min) {
    .grid5 {
  ...
  @media screen and (max-device-width: @sm-min) {
    .grid5 {
  ...
  .grid5_item_2>img {
    @media screen and (min-device-width: @sm-min) and (max-device-width: @md-min) {
      object-fit: cover;
    }
  }
  ...
  .grid5_item_1>img {
    ...
    @media screen and (min-device-width: @md-min) {
      aspect-ratio: 1.6;
