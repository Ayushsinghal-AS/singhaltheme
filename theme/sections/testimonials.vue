<template>
  ...
  :class='[global_config.props.anim_name]'  
  :style="`margin-bottom: ${global_config.props.margin_between}px;`">
    ...
    <div class="fadeInUp" style="display:flex" :class='["quotes-slider","mirror_layout-" + settings.props.mirror_layout.value]'>
      ...
      <div class="glide-cont1 glide" :class="'glide'+ _uid" ref="glide">
      ...
      <template v-if="getSectionValue(settings,'style_layout') === 'style2'"> 
        <div class="glide-cont2" :class="'glide'+ _uid" ref="glide">
          <div data-glide-el="track" class="glide__track">
            <div class="glide__slides" :class="{ 'ssr-slides-box': !checkisBrowser() && !isMounted }">    
...
export default {
  ...
  beforeMount() {
    if(this.getSectionValue(this.settings,'style_layout') ==='style1') {
      this.glideOptions.swipeThreshold = false;
      this.glideOptions.dragThreshold = false;
